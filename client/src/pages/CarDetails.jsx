      ...
      <button onClick={()=> navigate(-1)} className='flex items-center gap-2 mb-6 text-gray-500'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
          ...
          <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
              <p className='flex items-center justify-between text-2xl text-gray-800 font-semibold'>{currency}{car.pricePerDay}<span className='text-base text-gray-400 font-normal'>per hr</span></p>

              <hr className='border-borderColor my-6'/>

              <div className='flex flex-col gap-2'>
                <label htmlFor="pickup-date">Pickup Date <i>(MM-DD-YYYY)</i></label>
              ...
              <div className='flex flex-col gap-2'>
                <label htmlFor="return-date">Return Date <i>(MM-DD-YYYY)</i></label>
